...
" => PHP Section
""""""""""""""""""""""""""""""
" higlights interpolated variables in sql strings and does sql-syntax highlighting
au FileType php let php_sql_query=1
au FileType php let php_htmlInStrings=1
au FileType php let php_noShortTages=1
...
" Open Line Above/Below Text
nmap <leader>l :put =''<esc>
nmap <leader>L :put! =''<esc>

" Keyword Program
autocmd FileType php set keywordprg=phpm
